		...
		<div class="row gx-5 align-items-center justify-content-center">
			<div class="col-lg-8 col-xl-7 col-xxl-6">
				<div class="my-5 text-center text-xl-start">
					...
					<?php endif; ?>
					<?php if (pods_field_display('subheading')) : ?>
					...
					<?php endif; ?>
					<?php if (pods_field_display('button_1_text')) : ?>
						<a class="btn btn-outline-light btn-lg px-4" href="<?php echo pods_field_display('button_2_url'); ?>"><?php echo pods_field_display('button_2_text'); ?></a>
					<?php endif; ?>
					</div>
				</div>
			</div>
			<?php if (pods_field_display('right_image')) : ?>
				<div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="<?php echo pods_field_display('right_image'); ?>" alt="..." /></div>
			<?php endif; ?>
		</div>
	</div>
</header>
...
<?php if (pods_field_display('enable_headed_2') == 'Yes') : ?>
<!-- Header-->
<header class="py-5">
	<div class="container px-5">
